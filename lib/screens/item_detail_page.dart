...
import 'package:mamio/models/item_entry.dart';  // Import model ItemEntry
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            Text("Category: ${item.fields.category}", style: const TextStyle(fontSize: 16)),
            const SizedBox(height: 10),
            Text("Rating: ${item.fields.rating}", style: const TextStyle(fontSize: 16)),
            const SizedBox(height: 10),
            Text("Discount: ${item.fields.discount}", style: const TextStyle(fontSize: 16)),
