...
Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: const Color(0xFFFFF9BF),  // Background color
      appBar: AppBar(
        title: const Center(
          child: Text(
            'Form Tambah Item',
        ...
        backgroundColor: const Color.fromARGB(255, 162, 2, 90),  // Header color updated
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        // Kirim ke Django dan menunggu respons
